...
## 📊 Project Overview
This project uses bioactivity data from the ChEMBL database to train a machine learning model capable of predicting the potency ($pIC_{50}$) of small molecules against the Epidermal Growth Factor Receptor (EGFR). 
...
1. **Salmeterol Xinafoate** ($pIC_{50}$: 9.09)
2. **Zanamivir** ($pIC_{50}$: 9.03)
3. **Olsalazine** ($pIC_{50}$: 8.94)
